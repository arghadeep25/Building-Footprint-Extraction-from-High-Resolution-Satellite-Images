...
Start Training:
    ...
    Evaluate:        {}
        ...
        '''.format(str(self.train_path), str('PSPNet'), self.image_size,
        ...
        keras.utils.plot_model(model, to_file = 'pspnet_architecture.png')
